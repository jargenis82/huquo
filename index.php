...
$newPage = (isset($_GET ['newPage']) and comprobarVar ( $_GET ['newPage'] )) ? trim ( $_GET ['newPage'] ) : "0";

// Si el usuario ya se validó debe tener una variable de sesión 'user_id' activa
if (isset($_SESSION ['user_id']) and comprobarVar ( $_SESSION ['user_id'] )) {
	...
	$page = (isset($_GET ['page']) and comprobarVar ( $_GET ['page'] )) ? trim ( $_GET ['page'] ) : "quote_oppor_list";
	$page .= ".php?";
	// Valida gets extra
