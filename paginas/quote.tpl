	...
	<div class="container">
		<div class="col-sm-8">
			<div class="panel panel-primary">
				<div class="panel-heading">Hubrox Technology Inc</div>
				<div class="panel-body">
					<table class="table-responsive">
						<tr>
							<td colspan="2"><label>370 Magnetic Dr. North York,
									ON M3J 2C4,Toronto, Canadá</label></td>

						</tr>
						<tr>
							<td><label>Phone:</label></td>
							<td>+ 1-647-499-5741</td>
						</tr>
						<tr>
							<td><label>Website: </label></td>
							<td><a href="http://www.hubrox.com/">www.hubrox.com</a></td>
						</tr>
						<tr>
					...
					<div class="table-responsive">
						<table class="table-responsive" border="0">
							...
							<tr>
								...
								<td rowspan="3"><textarea rows="4" cols="90"
